...
<div class="w3-bar w3-white w3-large">
  ...
  <a href="login.php" class="w3-bar-item w3-right w3-button w3-mobile">Login</a>
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      ...
      <div class="w3-container w3-white">
        ...
        <button class="w3-button w3-block w3-black w3-margin-bottom" disabled>Buy Now</button>
      </div>
    </div>
    <div class="w3-third w3-margin-bottom">
...
<script src="https://apps.elfsight.com/p/platform.js" defer></script>  <!--https://apps.elfsight.com/-->
